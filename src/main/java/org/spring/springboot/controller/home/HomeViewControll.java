...
public class HomeViewControll {
    ...
    public String toHomejsp(HttpServletRequest request, HttpServletResponse response,ModelMap model) throws ServletException, IOException {
    	String res = "error";
		...
		String state = request.getParameter("state");
    		 ...
    		 */
    		JSONObject userInfoJO =WXOpenidUtil.auth(request, response, code);
    		if(userInfoJO==null){
                ...
                /**根据openid获取 对应用户 如果没有 则进行创建*/
	        		...
	        		if("00".equals(resInfo.getResCode())){
	        			...
	        			if(cUpdate.getUserId()!=null) {
		        			...
		        			logger.info("--resInfoupdate-:code: "+resInfoupdate.getResCode()+"msg: "+resInfoupdate.getResMsg());
	        			}
	        		};
